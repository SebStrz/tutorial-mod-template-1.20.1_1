...
import net.sebastian.tutorialmod.block.custom.SoundBlock;
...
public class ModBlocks {
    ...
    public static final Block RUBY_PRESSURE_PLATE = registerBlock("ruby_pressure_plate",
            new PressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING ,
                    FabricBlockSettings.copyOf(Blocks.STONE_PRESSURE_PLATE).sounds(BlockSoundGroup.AMETHYST_BLOCK),
                    BlockSetType.IRON));
    ...
    public static final Block RUBY_LAMP_BLOCK = registerBlock("ruby_lamp_block",
            new RubyLampBlock(FabricBlockSettings.create().mapColor(MapColor.RAW_IRON_PINK).instrument(Instrument.BELL)
                    .strength(4f).requiresTool().luminance(state ->state.get(RubyLampBlock.CLICKED) ? 15 : 0)));
